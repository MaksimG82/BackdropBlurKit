...
/// Defines the supported visual effect algorithms and their associated parameters.
public enum EffectConfiguration: Hashable, Sendable {
    ...
    /// The default effect configuration applied when no explicit override is provided.
    public static let `default`: EffectConfiguration = .gaussian(radius: 8)
}
