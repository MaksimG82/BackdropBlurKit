...
/// events, and capture entry/exit — across `BlurSnapshotStore`, `BlurTargetViewModifier`, and
/// `BlurSource`. Intentionally left in place rather than stripped after debugging; see
